          ...
          {loaded ? (
            <ReportEditor
              ...
              labels={{
                ...
                textBox: t(copy.reportTextBox),
                shapeRect: t(copy.reportShapeRect),
                shapeEllipse: t(copy.reportShapeEllipse),
                shapeLine: t(copy.reportShapeLine),
                direction: t(copy.reportDirection),
                nudge: t(copy.reportNudge),
                themeLight: t(copy.reportThemeLight),
                themeDark: t(copy.reportThemeDark),
                fontSize: t(copy.reportFontSize),

...
| `/clients` | Clients + logos + live Odoo quotations/invoices — php-fpm GET pulls CRM (cached 60s); `artisan serve` lists SQL only. Tabs poll every 30s; **no CRM import/sync button** (Excel import remains) |
